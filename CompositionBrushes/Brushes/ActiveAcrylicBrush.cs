...
using CompositionBrushes.Factories;
...
{
  public class ActiveAcrylicBrush : XamlCompositionBrushBase
  {
    public static readonly DependencyProperty TintColorProperty =
      DependencyProperty.Register("TintColor", typeof(Color), typeof(ActiveAcrylicBrush), new PropertyMetadata(Color.FromArgb(255, 255, 255, 255)));

    public static readonly DependencyProperty TintOpacityProperty =
      DependencyProperty.Register("TintOpacity", typeof(double), typeof(ActiveAcrylicBrush), new PropertyMetadata(1.0));

    public static readonly DependencyProperty TintLuminosityOpacityProperty =
      DependencyProperty.Register("TintLuminosityOpacity", typeof(double?), typeof(ActiveAcrylicBrush), new PropertyMetadata(null));

    public static new readonly DependencyProperty FallbackColorProperty =
      DependencyProperty.Register("FallbackColor", typeof(Color), typeof(ActiveAcrylicBrush), new PropertyMetadata(Color.FromArgb(255, 255, 255, 255)));

    private readonly ActiveAcrylicBrushFactory _factory;
    ...
    public ActiveAcrylicBrush()
    {
      _factory = new ActiveAcrylicBrushFactory();
